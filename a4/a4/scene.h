...
#define INIT_MAX_PHOTON_DIST  0.1
#define INIT_MAX_PHOTON_COUNT 100
...
public:
	...
	Scene() {
		...
		sceneScale = 1;
		buttonDown = -1;
		maxPhotonDist = INIT_MAX_PHOTON_DIST;
		maxPhotonCount = INIT_MAX_PHOTON_COUNT;
	}
	...
	bool findRefractionDirection(vec3& rayDir, vec3& N, vec3& refractionDir, int flag);
