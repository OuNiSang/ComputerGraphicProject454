...

{
	...
	if (rayDir * N < 0) {       // entering surface: assume air-to-glass transition
		...
		n2 = 1.510;
		dir = -1;
		criticalAngle = asin(n1 / n2); //FROM:https://courses.lumenlearning.com/austincc-physics2/chapter/25-4-total-internal-reflection/
	}
	...
	// For any angle greater than criticalAngle  will be treat as reflection
